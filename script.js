...
function funcao_resposta(){
    ...
    if(resp1 && resp2 && resp3 && resp4 && resp5 && resp6 && resp4resp7 && resp8 && resp9 && resp10){
        if(resp1.value == "correta"){
            ...
            document.getElementById("resp_errada_1").innerHTML = "Incorreta"
        ...
        if(resp2.value == "correta"){
            ...
            document.getElementById("resp_errada_2").innerHTML = "Incorreta"
        ...
        if(resp3.value == "correta"){
            ...
            document.getElementById("resp_errada_3").innerHTML = "Incorreta"
       ...
       c
        if(resp4.value == "correta"){
            ...
            document.getElementById("resp_errada_4").innerHTML = "Incorreta"
          ...
          if(resp5.value == "correta"){
            ...
            document.getElementById("resp_errada_5").innerHTML = "Incorreta"
        ...
        if(resp6.value == "correta"){
            ...
            document.getElementById("resp_errada_6").innerHTML = "Incorreta"
        ...
        if(resp7.value == "correta"){
            ...
            document.getElementById("resp_errada_7").innerHTML = "Incorreta"
        }
        if(resp8.value == "correta"){
            ...
            document.getElementById("resp_errada_8").innerHTML = "Incorreta"
            ...
            document.getElementById("resp_errada_9").innerHTML = "Incorreta"
